# leds.py
# Módulo de controlo de LEDs WS281x por segmentos (direita por posição)
...
# Segmentação (LEDs à direita por posição)
SEGMENT_MAP = {
    ...
    4: [9, 10],       # LEDs 10-11  
    5: [12, 13],      # LEDs 13-14
    6: [14, 15, 16],  # LEDs 15-17
    7: [17, 18],      # LEDs 18-19
    8: [20, 21],      # LEDs 21-22
    9: [23, 24],      # LEDs 24-25
    10: [25, 26, 27], # LEDs 26-28
    11: [28, 29, 30], # LEDs 29-31
    12: [31, 32, 33]  # LEDs 32-34
}
...
def blink_led(position: int, color: Color = YELLOW, duration: float = 1.5, blinks: int = 3):
    """Pisca os LEDs da posição especificada (alias para blink_segment)."""
